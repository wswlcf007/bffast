...
import com.lcf.fast.common.util.BFSpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        //获取spring bean
        ScheduleJobLogService scheduleJobLogService = (ScheduleJobLogService) BFSpringContextUtils.getBean("scheduleJobLogService");
        ...
        try {
            ...
            Object target = BFSpringContextUtils.getBean(scheduleJob.getBeanName());
